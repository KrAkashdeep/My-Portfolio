function About() {
  return (
    <>
      <div className="z-20 gap-24 p-16 flex items-center justify-center min-h-screen">
        <h1 className="text-4xl font-semibold mt-10 ml-10">About Me..</h1>
        <p className="mt-5 text-m p-52">
          ...
          <b className="text-gray-800"> data analytics </b> has sharpened my
          ...
          <b className="text-gray-800"> AI </b> to unlock the potential of
